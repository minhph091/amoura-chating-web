// Re-export all icons from separated files
export * from './icons/NavigationIcons';
export * from './icons/ActionIcons';

// Additional icons that are not in the separated files
...
// Additional icons needed for the UI improvements
export const MoreVertical = ({ size = 24, className = "" }) => (
    <svg xmlns="http://www.w3.org/2000/svg" width={size} height={size} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className={className}>
